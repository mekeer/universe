...
export default class ByGravity {
  ...
  static toGravityList(starList: Array<Star>, fps: number) {
  ...
  generageAcceleration(spe: Spe, quality: number, fps: number) {
    // console.log(fps);
   ...
   * @memberof ByGravity
   */
  public static generageGravity(star1: Star, star2: Star) {
    return (
  ...
  public static toGravity(star1: Star, star2: Star) {
    let byGravity = new ByGravity();
